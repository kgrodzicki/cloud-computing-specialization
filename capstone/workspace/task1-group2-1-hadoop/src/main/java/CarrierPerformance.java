...
public class CarrierPerformance {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job_1 = getInstance(conf, "Carriers performance");
        ...
        job_1.setJarByClass(CarrierPerformance.class);
        job_1.waitForCompletion(true);

        Job job_2 = getInstance(conf, "Top Carriers");

        job_2.setMapperClass(TopCarriersMapper.class);
        job_2.setReducerClass(TopCarriersReducer.class);
        ...
        job_2.setJarByClass(CarrierPerformance.class);
        job_2.setNumReduceTasks(40);
